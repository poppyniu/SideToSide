Feature:Test function on boot logo page

  @boot
  Scenario Outline: Test add a new boot logo and enable to mobile side
...
#    And Input <name1> and <password1> and click login button in <country>
    And Login to <platform> mobile to verify boot logo is effective
